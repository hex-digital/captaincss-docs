...
<template preview>
  <div class="flex">
    ...
    <div class="w-3 h-44 border-l-4 border-purple-600"></div>
  </div>
</template>

<div class="layout">
    <div class="layout__item u-w-1/3">1</div>
    <div class="layout__item u-w-1/3">2</div>
    <div class="layout__item u-w-1/3">3</div>
    <div class="layout__item u-w-1/3">4</div>
    <div class="layout__item u-w-1/3">5</div>
    <div class="layout__item u-w-1/3">6</div>
</div>
```
