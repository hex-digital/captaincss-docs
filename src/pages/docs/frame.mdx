  ...
  <table className="w-full text-left border-collapse">
    ...
    <tr>
      ...
      <td className="py-2 font-mono text-xs text-light-blue-600 whitespace-pre">
        --frame-antecedent: 9px;<br />
        --frame-consequent: 16px;<br />
...
constrain the content to a particular aspect ratio without squashing or distortion the content.
...
this is done by setting the width and height to 100% and giving is `object-fit: cover`.
