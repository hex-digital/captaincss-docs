...
Instead, it is best practice to create a partial application function, or a higher-order function, which stores the base
font size and uses it automatically for each call.
